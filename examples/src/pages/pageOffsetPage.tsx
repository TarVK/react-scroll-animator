...
export const PageOffsetPage = () => (
    <div>
        ...
        <Animator
            ...
            {({$scrollIn, $text, $scrollOut}, _, {$textOffset}) => (
                <>
                    ...
                    {/* This background will enter the view when the $text section animation starts */}
                    <div
                        style={{
                            backgroundColor: "cyan",
                            position: "absolute",
                            top: $textOffset + document.body.clientHeight,
                            zIndex: -1,
                            width: "100%",
                            height: "100%",
                        }}></div>
